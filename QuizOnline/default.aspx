<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="QuizOnline._default" %>
    ...
    <div class="rt-bg">
        <div class="rt-bg2">
            <div id="wrapper">
                ...
                <!-- #header-->
                <div id="content">
                    <div class="block" id="loginbox">
                        <div class="module-surround">
                            <div>
                                <h2>Login </h2>
                            </div>
                            <div class="module-content">
                                <div class="custom" style="padding-left: 60px;">
